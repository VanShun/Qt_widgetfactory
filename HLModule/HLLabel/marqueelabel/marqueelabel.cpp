...
void MarqueeLabel::setText(const QString &text)
{
    if (text != "") {
        ...
        //qDebug() << text << m_textwidth << m_textheight << endl;

        m_labText->resize(QSize(m_textwidth + 100, m_textheight + 5));
...
void MarqueeLabel::setFontsize(int fontsize)
{
    m_fontsize = fontsize;
    setText(m_text);
}
